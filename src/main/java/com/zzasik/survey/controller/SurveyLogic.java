...
public class SurveyLogic {
	...
	public Map<String,Object> Meta(int height, int weight, int age, String gender, int activity) {
	...
	public ArrayList<String> Logic (double BMI, int age, String gender, int activity){
	...
	public ArrayList<String> Logic4 (ArrayList<String> arrList, String p_sickness,  String p_sickness2,  String p_sickness3){
		...
		if(p_sickness2 == "당뇨병") {
			arrList.remove(String.valueOf("저탄고지"));
			arrList.remove(String.valueOf("고칼로리식단"));
		}else if(p_sickness2 == "저혈압") {
			arrList.remove(String.valueOf("고칼로리식단"));
			arrList.remove(String.valueOf("저염식"));
		}else if(p_sickness2 == "고혈압") {
			arrList.remove(String.valueOf("저탄고지"));
			arrList.remove(String.valueOf("고칼로리식단"));
		}else if(p_sickness2 == "신장질환") {
			arrList.remove(String.valueOf("저탄고지"));
			arrList.remove(String.valueOf("고칼로리식단"));
		}else if(p_sickness2 == "심장병") {
			arrList.remove(String.valueOf("저염식"));
			arrList.remove(String.valueOf("저탄고지"));
			arrList.remove(String.valueOf("고칼로리식단"));
		}else if(p_sickness2 == "빈혈") {
			arrList.remove(String.valueOf("저염식"));
			arrList.remove(String.valueOf("고칼로리식단"));
		}
		...
		if(p_sickness3 == "당뇨병") {
			arrList.remove(String.valueOf("저탄고지"));
			arrList.remove(String.valueOf("고칼로리식단"));
		}else if(p_sickness3 == "저혈압") {
			arrList.remove(String.valueOf("고칼로리식단"));
			arrList.remove(String.valueOf("저염식"));
		}else if(p_sickness3 == "고혈압") {
			arrList.remove(String.valueOf("저탄고지"));
			arrList.remove(String.valueOf("고칼로리식단"));
		}else if(p_sickness3 == "신장질환") {
			arrList.remove(String.valueOf("저탄고지"));
			arrList.remove(String.valueOf("고칼로리식단"));
		}else if(p_sickness3 == "심장병") {
			arrList.remove(String.valueOf("저염식"));
			arrList.remove(String.valueOf("저탄고지"));
			arrList.remove(String.valueOf("고칼로리식단"));
		}else if(p_sickness3 == "빈혈") {
			arrList.remove(String.valueOf("저염식"));
			arrList.remove(String.valueOf("고칼로리식단"));
		}
