    ...
    return (
        ...
        <div>
            ...
            <div class="first_div">
                ...
                <div class="event_div_1">
                    ...
                    <br/>
                    <div class="evenet_div_2"><a class="temp_3">가격</a><a class="temp_4">{board.board_price}원</a></div>
                    <div class="evenet_div_2"><a class="temp_3">카드혜택</a><a class="temp_4">무이자할부 최대 6개월</a></div>
        ...
        <>  <div class="join_btn"><button class="join_btn" onClick={modifyBtn}>수정하기</button></div>
                    ...
                    <div class="exp_box">
                        ...
                        <div class="exp_box_2">
                            <img  class="zz"  src='/img/calendar.png' />
                            <div class="text_1">1주 식사플랜</div>
                            <br/>
                            <div class="text_2">건강한 맞춤 식사 플랜제공</div>
                        </div>
                        <div class="exp_box_2">
                            <img class="zz" src='/img/phone.png' />
